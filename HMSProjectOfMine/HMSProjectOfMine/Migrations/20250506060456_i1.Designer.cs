...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HMSProjectOfMine.Models.Patient", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Age = 0,
                            FirstName = "Maria",
                            FirstVisitDate = new DateTime(2025, 5, 6, 12, 4, 54, 983, DateTimeKind.Local).AddTicks(7742),
                            Gender = "Female",
                            LastName = "Ahmed",
                            PatientNo = "1A",
                            PatientType = "Outdoor",
            ...
            modelBuilder.Entity("HMSProjectOfMine.Models.Prescription", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            PrescriptionId = 1,
                            DoctorId = 1,
                            NextVisitDate = new DateTime(2025, 5, 29, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            PrescriptionDate = new DateTime(2025, 5, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            TokenId = 1
                        },
                        new
                        {
                            PrescriptionId = 2,
                            DoctorId = 1,
                            NextVisitDate = new DateTime(2025, 6, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            PrescriptionDate = new DateTime(2025, 5, 2, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            TokenId = 1
                        });
                });
            ...
            modelBuilder.Entity("HMSProjectOfMine.Models.TestReport", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsFinalized = false,
                            PrescriptionTestId = 1,
                            ReportDate = new DateTime(2025, 5, 29, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            TestResult = "No Issues Found"
                        });
                });
            ...
            modelBuilder.Entity("HMSProjectOfMine.Models.PrescriptionDiagnosis", b =>
                {
                    b.HasOne("HMSProjectOfMine.Models.Prescription", "Prescription")
                        .WithMany("PrescriptionDiagnosises")
                        .HasForeignKey("PrescriptionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("HMSProjectOfMine.Models.Prescription", b =>
                {
                    ...
                    b.Navigation("PrescriptionDiagnosises");
